...
#import "MUIBigSplitViewController.h"
...
@interface MUIBigSplitViewController()
...
@implementation MUIBigSplitViewController
...
@implementation UIViewController (MUIBigSplitViewController)

- (MUIBigSplitViewController *)mui_bigSplitViewController{
    UISplitViewController *svc = self.splitViewController;
    if([svc isKindOfClass:MUIBigSplitViewController.class]){
        return (MUIBigSplitViewController *)svc;
    }
    return svc.mui_bigSplitViewController;
}
