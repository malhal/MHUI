...
@interface MUIFlipController : UITabBarController
...
@interface UIViewController (MUIFlipControllerItem)
...
@property(nullable, nonatomic, readonly, strong) MUIFlipController *flipController; // If the view controller has a tab bar controller as its ancestor, return it. Returns nil otherwise.
