...
#import "MHUDictionaryViewController.h"

@interface MHUDictionaryViewController()

@property NSArray* keys;

@end

@implementation MHUDictionaryViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    MHUDictionaryViewController* dvc = [[MHUDictionaryViewController alloc] initWithStyle:UITableViewStylePlain];
    dvc.dictionary = d;
    dvc.title = key;
